...
namespace Player
{
    public class PlayerMover : MonoBehaviour
    {
        ...
        {
#if UNITY_STANDALONE
            this.transform.rotation *= Quaternion.Euler(0, rotateSpeed * Input.GetAxis("Mouse X") * Time.deltaTime, 0);
            m_Camera.transform.rotation *= Quaternion.Euler(-rotateSpeed * Input.GetAxis("Mouse Y") * Time.deltaTime, 0, 0);
#elif UNITY_WSA
            ...
            {
                this.transform.rotation *= Quaternion.Euler(0, Time.deltaTime * rotateSpeed * Input.GetAxis("Touch"), 0);
            }
#endif
